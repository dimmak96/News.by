            ...
            <h2>
                ...
                <?php
                    ...
                    <div style="height:200px;background-color:#6c7684;margin-top:40px;margin-bottom:10px">
                        ...
                        <a style="color:#333333;float: right;padding-top: 10px;" href="#add-comment-form"><p class="add-comment-link"
                                                                            onclick="document.getElementById('add-comment-form').style.display='block'">
                                Добавить свой</p></a>
                    ...
                    <div id="add-comment-form">
                        <form>
                            <h5 style="text-align:center;padding-top:10px;">Добавить комментарий
                                <h5>
                                    <br/>
                                    <textarea class="form-control" rows="2" style="width:50%;margin-left:25%"
